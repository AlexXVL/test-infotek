...
class BookController extends Controller
{
    ...
    {
        $this->bookService = Yii::app()->bookService;
     ...
     * @throws CHttpException|CDbException
     */
	 ...
	 */
	protected function performAjaxValidation(Book $model): void
    {
